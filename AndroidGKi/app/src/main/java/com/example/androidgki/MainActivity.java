...
//                String[] chitiet = new String[1000];
//                for(int i=0;i<input.length;i++)
//                    arr1[i] = Integer.parseInt(input[i].toString());
//                String[] input = txtDaySo.getText().toString().split(" ");
//                int[] arr = new int[input.length];
//                for(int i=0;i<input.length;i++)
//                    arr[i] = Integer.parseInt(input[i].toString());
...
//                    d += " " + String.valueOf(arr1[o]);
//                }
//                intent.putExtra("chuoi",d);
//                startActivity(intent);
...
//                Bundle bundle = data.getBundleExtra("nhom9");
//        arr = bundle.getIntArray("chuoi");
//        giaithuat = bundle.getString("giaithuat");
//        //xử lí kết quả
